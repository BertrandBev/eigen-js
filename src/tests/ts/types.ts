// TODO I wish it could just pick eig namespace from eigen.d.ts file, but it does not work yet
...
export interface TripletVector {
...
export interface SimplicialCholesky {
  solve(vec: Matrix): Matrix
}

export type MatrixVector = Matrix
